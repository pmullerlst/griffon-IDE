...
void file_save (void)
{
	...
	else
	{
		...
		gchar *newlabel = g_path_get_basename (cur_text_doc->file_name);
		griffon_notify(_(g_strconcat ("Save [OK] : ",newlabel,NULL)));
...
void show_save_as_dlg (int mode)
{
	...
	if (gtk_dialog_run (GTK_DIALOG (file_dialog)) == GTK_RESPONSE_ACCEPT)
	{
		...
		if (! text_doc_save (cur_text_doc, cur_text_doc->file_name))
		{
			...
			gchar *newlabel = g_path_get_basename (cur_text_doc->file_name);
			griffon_notify(_(g_strconcat ("Save [ERROR] : ",newlabel,NULL)));
			return;
		}
...
void exe(void)
{
	...
	gchar *newlabel = g_path_get_basename (cur_text_doc->file_name);
	griffon_notify(_(g_strconcat ("Chmod [OK] : ",newlabel,NULL)));
}
...
void php_ftp_list_rep (void){doc_insert_at_cursor (cur_text_doc, (_("//******* List files in a $directory in array\n$array = ftp_nlist($ftp_connexion,\"$directory\");\n\n"))); }
void php_ftp_put (void){doc_insert_at_cursor (cur_text_doc, (_("ftp_put($ftp_connexion,$name_file_put,$path_file, FTP_BINARY);\n\n"))); }
void php_ftp_delete (void){doc_insert_at_cursor (cur_text_doc, (_("ftp_delete($ftp_connexion, $file_delete);\n\n"))); }
...
void php_htmlentities(void){doc_insert_at_cursor (cur_text_doc, (_("$str=htmlentities($str);\n")));}
void php_nl2br(void){doc_insert_at_cursor (cur_text_doc, (_("$str=nl2br($str);\n")));}
...
void css_template_table (void){doc_insert_at_cursor (cur_text_doc, "table\n{\nborder-collapse:collapse;\nwidth:100%;\nmax-width:700px;\nmin-width:400px;\nbox-shadow:2px 2px 5px #555753;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\n}\n\ncaption\n{\ncaption-side:bottom;\nfont-weight:bold;\nfont-style:italic;\nmargin:4px;\n}\n\n\ntd \n{\nheight: 14px;\npadding:4px;\nvertical-align:middle;\nborder: 1px solid black;\n}\n\nth\n{\nheight: 14px;\npadding:4px;\nvertical-align:middle;\nbackground: #020405;\nbackground: linear-gradient(top,  #555753,  #888a85);\nbackground: -ms-linear-gradient(top,  #555753,  #888a85);\nbackground: -webkit-gradient(linear, left top, left bottom, from(#555753), to(#888a85));\nbackground: -moz-linear-gradient(top,  #555753,  #888a85);\ncolor: white;\nborder: 1px solid black;\n}\n\n.rowtitle\n{\nbackground: #9CF;\nfont-weight:bold;\n}\n\ntable tr:nth-child(odd) td\n{\n  background-color: #d3d7cf;\n}\n"); }
void css_template_submit (void){doc_insert_at_cursor (cur_text_doc, "input[type=\"submit\"] {\nfont-family: arial;\ncolor: #FFFFFF !important;\nfont-size: 14px;\nbox-shadow: 1px 1px 1px #BEE2F9;\npadding: 5px 24px;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\nborder: 1px solid black;\nbackground: #020405;\nbackground: linear-gradient(top,  #555753,  #888a85);\nbackground: -ms-linear-gradient(top,  #555753,  #888a85);\nbackground: -webkit-gradient(linear, left top, left bottom, from(#555753), to(#888a85));\nbackground: -moz-linear-gradient(top,  #555753,  #888a85);\nfont-weight:bold;\nbox-shadow:2px 2px 5px #555753;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\n}\n\ninput[type=\"submit\"]:hover {\ncolor: #FFFFFF !important;\nbackground: #555753;\nbackground: linear-gradient(top,  #2A5C34,  #578235);\nbackground: -ms-linear-gradient(top,  #2A5C34,  #578235);\nbackground: -webkit-gradient(linear, left top, left bottom, from(#2A5C34), to(#578235));\nbackground: -moz-linear-gradient(top,  #2A5C34,  #578235);\nfont-weight:bold;\n}\n"); }
void css_template_menu (void){doc_insert_at_cursor (cur_text_doc, "#menu{\nposition:relative;\nborder: 1px solid black;\nheight:43px;\nfont-size:14px;\ntext-transform:uppercase;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\nborder: 1px solid black;\nbackground: #020405;\nbackground: linear-gradient(top,  #555753,  #888a85);\nbackground: -ms-linear-gradient(top,  #555753,  #888a85);\nbackground: -webkit-gradient(linear, left top, left bottom, from(#555753), to(#888a85));\nbackground: -moz-linear-gradient(top,  #555753,  #888a85);\nfont-weight:bold;\nfont-family:Georgia, \"Times New Roman\", Times, serif;\nbox-shadow:2px 2px 5px #555753;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\n}\n\n#menu ul{margin:0;padding:0;list-style-type:none;width:auto;float:left;}\n#menu ul li{display:block;float:left;margin:0 2px;}\n#menu ul li a{display:block;float:left;color:#FFFFFF;text-decoration:none;padding:0 0 0 25px;height:43px;line-height:50px;}\n#menu ul li a span{display:block;float:left;padding:0 25px 0 0;height:31px;width:auto;}\n#menu ul li a:hover{color:#fff;}\n#menu ul li a:hover span{display:block;cursor:pointer;}\n\n#menu ul li a.current,#menu ul li a.current:hover\n{\ncolor: #FFFFFF;\nbackground: #555753;\n}\n\n#menu ul li a.current span{height:43px;}\n\n/*\n<div id=\"menu\">\n	<ul>\n		<li><a href=\"#\" title=\"css menus\" class=\"current\"><span>Home</span></a></li>\n		<li><a href=\"#\" title=\"css menus\"><span>About Us</span></a></li>\n		<li><a href=\"#\" title=\"css menus\"><span>Services</span></a></li>\n		<li><a href=\"#\" title=\"css menus\"><span>Our Work</span></a></li>\n		<li><a href=\"#\" title=\"css menus\"><span>Contact Us</span></a></li>\n	</ul>\n</div>\n*/\n"); }
void css_template_box (void){doc_insert_at_cursor (cur_text_doc, "#box{\nbox-shadow:2px 2px 5px #555753;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;padding: 5px 24px;\nborder: 1px solid black;\n}\n\n/*\n<div id=\"box\">\nTEST\n</div>\n*/\n"); }
void css_template_textarea (void){doc_insert_at_cursor (cur_text_doc, "input[type=\"text\"],input[type=\"email\"],input[type=\"tel\"],textarea {\n	border:2px solid #555753;\n	border-radius:10px;\nbox-shadow:2px 2px 5px #555753;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\n}\n"); }
void css_template_label (void){doc_insert_at_cursor (cur_text_doc, "#label {\n  position: relative;\n  display: inline;\n  color: #FFFFFF;\n  background: #555753;\n  height: 30px;\n  line-height: 30px;\n  text-align: center;\n  border-radius: 6px;\n  padding:4px;\nbox-shadow:2px 2px 5px #555753;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\n}\n\n#label span{\n  padding:4px;\n}\n\n#label span:after {\n  content: '';\n  position: absolute;\n  top: 50%;\n  left: 100%;\n  margin-top: -8px;\n  width: 0; height: 0;\n  border-left: 8px solid #555753;\n  border-top: 8px solid transparent;\n  border-bottom: 8px solid transparent;\n\n}\n\n/*\n<div id=\"label\"><span>TEST</span></div>\n*/\n"); }
void css_template_footer (void){doc_insert_at_cursor (cur_text_doc, "html, body {height: 100%;}\n#wrap {min-height: 100%;}\n\n#main {\noverflow:auto;\npadding-bottom: 130px;\n}\n\nfooter {\nbackground: #020405;\nbackground: linear-gradient(top,  #555753,  #888a85);\nbackground: -ms-linear-gradient(top,  #555753,  #888a85);\nbackground: -webkit-gradient(linear, left top, left bottom, from(#555753), to(#888a85));\nbackground: -moz-linear-gradient(top,  #555753,  #888a85);\ncolor: white;\nposition: relative;\nclear:both;\nmargin-top: -130px;\nheight: 135px;\nborder: 1px solid black;\nwidth:100%;\nmargin-left:-100px;padding-left:-100px;\nmargin-right:105px;padding-right:105px;\n}\n\n\n/*\n<div id=\"wrap\">\n<div id=\"main\" class=\"clearfix\">\n\nMAIN\n\n</div>\n</div>\n<footer></footer>\n*/\n\n"); }
...
void jquery_head (void){doc_insert_at_cursor (cur_text_doc, "	<script type=\"text/javascript\" src=\"jquery/external/jquery/jquery.js\"></script>\n	<script type=\"text/javascript\" src=\"jquery/jquery-ui.min.js\"></script>\n	<link type=\"text/css\" href=\"jquery/jquery-ui.min.css\" rel=\"stylesheet\" />\n"); }
void tablefilter_head (void){doc_insert_at_cursor (cur_text_doc, "	<script LANGUAGE=\"JavaScript\" src=\"TableFilter/tablefilter_all.js\"></script>\n	<link rel=\"stylesheet\" type=\"text/css\" href=\"TableFilter/filtergrid.css\"/>\n"); }
void tablefilter_source (void){doc_insert_at_cursor (cur_text_doc, "<script language=\"javascript\" type=\"text/javascript\">\n    //<![CDATA[\n	var table10_Props = {\n		sort: true,\n		paging: false,\n		paging_length: 50,\n		loader: true,\n		loader_text: \"Tableau de recherche en chargement ...\",\n		help_instructions: false,\n		rows_counter: false,\n		filters_row_index: 1,\n		refresh_filters: true\n	};\n	var tf102 = setFilterGrid( \"tableID\",table10_Props );\n	//]]>\n	</script>\n"); }
void jquery_autocomp (void){doc_insert_at_cursor (cur_text_doc, "<script>\n$(function() {\nvar availableTags = [\n\"ActionScript\",\n\"AppleScript\",\n\"Asp\",\n\"BASIC\",\n\"C\",\n\"C++\",\n\"Clojure\",\n\"COBOL\",\n\"ColdFusion\",\n\"Erlang\",\n\"Fortran\",\n\"Groovy\",\n\"Haskell\",\n\"Java\",\n\"JavaScript\",\n\"Lisp\",\n\"Perl\",\n\"PHP\",\n\"Python\",\n\"Ruby\",\n\"Scala\",\n\"Scheme\"\n];\n$( \"#search\" ).autocomplete({\nsource: availableTags\n});\n});\n\n/*\n<input type=\"text\" name=\"search\" id=\"search\">\n*/\n</script>\n"); }
void jquery_datepicker (void){doc_insert_at_cursor (cur_text_doc, "<script>\n\n/* French initialisation for the jQuery UI date picker plugin. */\n\n(function( factory ) {\n	if ( typeof define === \"function\" && define.amd ) {\n\n		// AMD. Register as an anonymous module.\n		define([ \"../jquery.ui.datepicker\" ], factory );\n	} else {\n\n		factory( jQuery.datepicker );\n	}\n}\n\n(function( datepicker ) {\n	datepicker.regional['fr'] = {\n		closeText: 'Fermer',\n		prevText: 'Précédent',\n		nextText: 'Suivant',\n		currentText: 'Aujourd\'hui',\n		monthNames: ['janvier', 'février', 'mars', 'avril', 'mai', 'juin',\n			'juillet', 'août', 'septembre', 'octobre', 'novembre', 'décembre'],\n		monthNamesShort: ['janv.', 'févr.', 'mars', 'avril', 'mai', 'juin',\n			'juil.', 'août', 'sept.', 'oct.', 'nov.', 'déc.'],\n		dayNames: ['dimanche', 'lundi', 'mardi', 'mercredi', 'jeudi', 'vendredi', 'samedi'],\n		dayNamesShort: ['dim.', 'lun.', 'mar.', 'mer.', 'jeu.', 'ven.', 'sam.'],\n		dayNamesMin: ['D','L','M','M','J','V','S'],\n		weekHeader: 'Sem.',\n		dateFormat: 'dd/mm/yy',\n		firstDay: 1,\n		isRTL: false,\n		showMonthAfterYear: false,\n		yearSuffix: ''};\n	datepicker.setDefaults(datepicker.regional['fr']);\n\n	return datepicker.regional['fr'];\n\n}));\n\n\n$(function() {\n//	$(\"#date\").datepicker($.datepicker.regional['fr']);\n       $( \"#date\" ).datepicker({ dateFormat: 'yy-mm-dd' });\n//	$( \"#date\" ).datepicker( \"option\", \"autoSize\", true );\n});\n\n/*\n<input type=\"text\" name=\"date\" id=\"date\">\n*/\n</script>\n");}
