...
void css_template_table (void){doc_insert_at_cursor (cur_text_doc, "table\n{\nborder-collapse:collapse;\nwidth:100%;\nmax-width:700px;\nmin-width:400px;\ntext-align:center;\nbox-shadow:2px 2px 5px #5C9643;\n-moz-border-radius: 10px;\n-webkit-border-radius: 10px;\nborder-radius: 10px;\n}\n\ncaption\n{\ncaption-side:bottom;\nfont-weight:bold;\nfont-style:italic;\nmargin:4px;\n}\n\n\ntd \n{\nheight: 14px;\npadding:4px;\nvertical-align:middle;\nborder: 1px solid black;\n}\n\nth\n{\nheight: 14px;\npadding:4px;\nvertical-align:middle;\nbackground: #020405;\nbackground: linear-gradient(top,  #1F9E1B,  #86DB3B);\nbackground: -ms-linear-gradient(top,  #1F9E1B,  #86DB3B);\nbackground: -webkit-gradient(linear, left top, left bottom, from(#1F9E1B), to(#86DB3B));\nbackground: -moz-linear-gradient(top,  #1F9E1B,  #86DB3B);\ncolor: white;\nborder: 1px solid black;\n}\n\n.rowtitle\n{\nbackground: #9CF;\nfont-weight:bold;\n}\n\ntable tr:nth-child(odd) td\n{\n  background-color: #E8F4D7;\n}\n"); }
