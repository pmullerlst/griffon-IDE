...
GtkWidget* create_tea_main_window (void)
{
	...
	gtk_window_set_title (GTK_WINDOW (tea_main_window), _("Griffon 1.6.7"));
...
//*********************** ONGLET MARK
  ...
  gtk_widget_show (GTK_WIDGET(item_entry));
	...
	gtk_widget_set_size_request (recent_file, 200, -1);
...
GtkWidget* rapport_window (void)
{
	...
	webkit_web_view_load_uri(webView_doc, "http://griffon.lasotel.fr/bug_rapport.php?clef=1.6.7");
