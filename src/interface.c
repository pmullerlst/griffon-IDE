...
GtkWidget* create_tea_main_window (void)
{
	...
	gtk_window_set_title (GTK_WINDOW (tea_main_window), _("Griffon 1.8.2"));
...
gchar* tampon_fixme=g_strdup_printf ("%d", nb_line_fixme) ;
  ...
  gtk_tool_item_set_tooltip_text(tool_miniweb_prev,_("Redo"));
	...
	gchar *uri_graph = g_strconcat("http://griffon.lasotel.fr/graph.php?version=1.8.2&todo=", tampon_todo,"&bug=",tampon_bug,"&fixme=",tampon_fixme, NULL);
...
GtkWidget* version_window (void)
{
	...
	webkit_web_view_load_uri(webView_doc, "http://griffon.lasotel.fr/version.php?version=1.8.2");
...
GtkWidget* rapport_window (void)
{
	...
	webkit_web_view_load_uri(webView_doc, "http://griffon.lasotel.fr/bug_rapport.php?clef=1.8.2");
...
gchar* tampon_fixme=g_strdup_printf ("%d", nb_line_fixme) ;
	...
	gchar *uri_main = g_strconcat("http://griffon.lasotel.fr/graph.php?version=1.8.2&todo=", tampon_todo,"&bug=",tampon_bug,"&fixme=",tampon_fixme, NULL);
